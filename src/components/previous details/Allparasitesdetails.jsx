...
console.log(data.pre,'data')
  ...
  return (
    <div>
      ...
      <h1 className='text-center my-5 heading'>Parasite Previous Details</h1>
        <div>
  ...
  {/* <center> <p className='my-2'><b>Total=</b></p></center>   */}
        ...
        <MaterialTable
      title="Parasites Previous Details"
      columns={[
...
export default Allparasitesdetails
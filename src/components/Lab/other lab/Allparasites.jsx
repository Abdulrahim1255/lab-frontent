      ...
      <Fragment>
       ...
       .then(response=>{
        ...
        if(response){
          ...
          setOrderBatch(`PR${response.data[0].count}`)
 }
...
<b> Required Analysis  : </b> 
    ...
    <Link to="/Allparasitesdetails">   <p className='text-right' > previous details</p></Link> 
          </div>

        </Container>
        <h1 className='text-center my-3 mb-5 heading'> Parasites Lab </h1>

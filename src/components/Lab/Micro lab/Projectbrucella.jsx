...
const Projectbrucella = (props) => {
    ...
    const [orderBatch,setOrderBatch]=React.useState("P")
...
try {
        ...
        console.log(update)
  await  axios.put(`${process.env.REACT_APP_DEVELOPMENT}/api/updateProjectbrucella/${update._id}`,combinedObj,
  {headers:{token:`${accessToken}`}})
  .then(response=>{
    console.log('Response',response)
  ...
  const deleteRow = async(update)=>{
        ...
        try {
          ...
          await  axios.delete(`${process.env.REACT_APP_DEVELOPMENT}/api/deleteProjectbrucella/${update._id}`,update,
